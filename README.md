...
- 🎙️ **Microphone & System Audio mixing**.
- 📷 **Webcam PIP Overlay** (round/rectangular).
- 📸 **Visible & Selected Area Screenshot capture** with built-in instant Markup Editor (Arrows, Rectangles, Circles, Highlighters, Blurring/Redaction, Text).
- 🎬 **Video Review, Trimmer & WebM/MP4 Exporter**.
- 📁 **Self-contained in-extension Studio** accessible anytime via `studio.html`.
